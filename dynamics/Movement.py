...
class move_particle:
    ...
    def stokes_settling(self, object, matrix_material, matrix_material_temp, matrix_material_pressure):
        """
        ...
        if f < 10: # low frictional coefficient, when body is in laminar flow regime
            ...
            print('f<10')
            print("f: {}, matrix_viscosity: {}, matrix_material: {}".format(f, matrix_viscosity, matrix_material))

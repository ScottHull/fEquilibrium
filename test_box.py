...
# instantiate the box
model = box(length=length, width=width, height=height, model_time=100, space_resolution=space_resolution,
...
model.insert_boundary(temperature=2200, z_range=[3.8,4], boundary_location='bottom')

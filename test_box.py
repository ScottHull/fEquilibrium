...
# instantiate the box
model = box(length=length, width=width, height=height, model_time=200, space_resolution=space_resolution, visualize_system=True, object_history=True)
...
model.insert_matrix(matrix_material='Silicate Liquid', composition={'SiO2': 50, 'FeO': 50, '182-Hf': 100},
                    z_range=[0,20], initial_temperature=2000)

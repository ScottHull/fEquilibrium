...
# instantiate the box
model = box(length=3, width=3, height=10, model_time=100, space_resolution=0.5, visualize_system=True, object_history=True)
...
for i in list(range(1)):
    model.insert_object(object='Metal Liquid', object_radius=0.04, x_coord=2,

...
# instantiate the box
model = box(length=length, width=width, height=height, model_time=50, space_resolution=space_resolution,
...
model.insert_boundary(temperature=2300, z_range=[2.8,3], boundary_location='bottom')

# insert X number of objects into the box, specify their location, will overwrite matrix at that point
for i in list(range(1)):
    model.insert_object(object='Metal Liquid', object_radius=0.06, x_coord=1.6,

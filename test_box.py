...
# instantiate the box
model = box(length=3, width=3, height=30, model_time=30, space_resolution=0.2, visualize_system=True, object_history=True)
...
for i in list(range(1)):
    model.insert_object(object='Metal Liquid', object_radius=0.6, x_coord=2,
...
model.update_system(deltaTime=4)
